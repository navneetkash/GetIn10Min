...
const MainBanner = () => {
    return (
        <div className='relative'>
            ...
            <div className='absolute inset-0 flex flex-col items-centre md:items-start justify-end md:justify-centre pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
                ...
                <div className='flex items-centre mt-6 font-medium'>
                    <Link to={"/products"} className='group flex items-centre gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull transition rounded text-whilte cursor-pointer'>Shop now
                        <img src={assets.white_arrow_icon} alt="arrow" className='md:hidden transition group-focus:translate-x-1' />
                    </Link>
                    <Link to={"/products"} className='group hidden md:flex items-centre gap-2 px-9 py-3 cursor-pointer'>Explore deals
